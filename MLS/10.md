...
<div>
$$
\lambda^* \in \mathop{\mathrm{argmin}}_{\lambda \in \Lambda} L(A_{\lambda}, D_{\mathrm{train}}, D_{\mathrm{valid}})
$$
</div>
...
<div>
$$
A^*, \lambda^* \in \mathop{\mathrm{argmin}}_{A^{(i)} \in \mathcal{A},\ \lambda \in \Lambda^{(i)}}
L(A_{\lambda}^{(i)}, D_{\mathrm{train}}, D_{\mathrm{valid}})
$$
</div>
